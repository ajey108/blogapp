...
const BlogTableItem = ({authorImg,title,author,date,mongoid,deleteBlog}) => {
  ...
  return (
    <tr className='bg-white border-b cursor-pointer'>
        <th scope='row' className='py-4 px-6 gap-3 hidden sm:flex font-medium text-gray-900 whitespace-nowrap'>
            <Image width={50} height={50} src = {authorImg?authorImg:'/authorImg.jpg'} alt='authorImage'/>
